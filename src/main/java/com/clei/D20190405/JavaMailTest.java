...
public class JavaMailTest {
    private final static String MAIL_TO = "yueyaye@163.com";
    //异常直接抛出了。。。
...
class MailSender{
    //用你自己的邮箱和授权码去。。。
    private final static String FROM = "hasaki@163.com";
    private final static String AUTHORIZATION_CODE = "hasaki";
